...
## [1.5.2](https://github.com/cgoing-bot/better-chatbot/compare/v1.26.0...v1.5.2) (2026-02-20)
...
* add DISABLE_EMAIL_SIGN_UP to control email and OAuth signups separately ([#331](https://github.com/cgoing-bot/better-chatbot/issues/331)) ([2811cf3](https://github.com/cgoing-bot/better-chatbot/commit/2811cf3dbcce03da467cd958587473326dab9cc1))
...
* add LaTeX/TeX math equation rendering support ([#318](https://github.com/cgoing-bot/better-chatbot/issues/318)) ([c0a8b5b](https://github.com/cgoing-bot/better-chatbot/commit/c0a8b5b9b28599716013c83cac03fa5745ffd403))
...
* add norwegian translation ([#341](https://github.com/cgoing-bot/better-chatbot/issues/341)) ([64f88cc](https://github.com/cgoing-bot/better-chatbot/commit/64f88cc37fab0613c0711d9b30bff84daae74839))
...
* Add support for Streamable HTTP Transport [#56](https://github.com/cgoing-bot/better-chatbot/issues/56) ([#64](https://github.com/cgoing-bot/better-chatbot/issues/64)) ([8783943](https://github.com/cgoing-bot/better-chatbot/commit/878394337e3b490ec2d17bcc302f38c695108d73))
...
* implement language selection component and enhance authentication UI with improved translations and user prompts ([d97d891](https://github.com/cgoing-bot/better-chatbot/commit/d97d891bc3d63b4a9ca0df829177e0368bc4a462))
...
* set maxTokens to 30 in generateTitleFromUserMessageAction for improved title generation ([7dde3f1](https://github.com/cgoing-bot/better-chatbot/commit/7dde3f156d60488488862967b40d81aa02a29955))
...
* align chat messages with prompt input ([#366](https://github.com/cgoing-bot/better-chatbot/issues/366)) ([e65be9f](https://github.com/cgoing-bot/better-chatbot/commit/e65be9f584aa2dd62123431d72e1192b23ffb527))
...
* Apply DISABLE_SIGN_UP to OAuth providers ([#282](https://github.com/cgoing-bot/better-chatbot/issues/282)) ([bcc0db8](https://github.com/cgoing-bot/better-chatbot/commit/bcc0db8eb81997e54e8904e64fc76229fbfc1338))
* blur prompt-input after submit to collapse mobile keyboard ([#337](https://github.com/cgoing-bot/better-chatbot/issues/337)) ([aec3530](https://github.com/cgoing-bot/better-chatbot/commit/aec35300c1ca7269aa5086a95f1a4f480b2564c7))
...
* enter ([78573e4](https://github.com/cgoing-bot/better-chatbot/commit/78573e4de8d509cf717123235e55e6d801eeb581))
...
* hide MCP server credentials from non-owners ([#317](https://github.com/cgoing-bot/better-chatbot/issues/317)) ([#319](https://github.com/cgoing-bot/better-chatbot/issues/319)) ([6e32417](https://github.com/cgoing-bot/better-chatbot/commit/6e32417535c27f1215f96d68b7302dba4a1b904d))
...
* **mcp:** enhance error messaging and client check logic ([449f5da](https://github.com/cgoing-bot/better-chatbot/commit/449f5da72ceadfc49e4af63990a5af8957498a5e))
...
* **mcp:** improve 401 detection for OAuth flow trigger ([#362](https://github.com/cgoing-bot/better-chatbot/issues/362)) ([a99dca9](https://github.com/cgoing-bot/better-chatbot/commit/a99dca9a26117dec41611a1f40038b80026a675b))
...
* preserve whitespace in chat input during editing ([#361](https://github.com/cgoing-bot/better-chatbot/issues/361)) ([e914a30](https://github.com/cgoing-bot/better-chatbot/commit/e914a30f66113c49b60ff3695b52db3d8d7e3a8f))
...
* skip signup method selection when only email is enabled ([#338](https://github.com/cgoing-bot/better-chatbot/issues/338)) ([7538bc8](https://github.com/cgoing-bot/better-chatbot/commit/7538bc8babb0943f2857a9a9139bff79e2c5e486))
...
* text message part inline buttons is not visible on mobile ([#334](https://github.com/cgoing-bot/better-chatbot/issues/334)) ([666c395](https://github.com/cgoing-bot/better-chatbot/commit/666c395865d03dd33884f9f17933b1a3659d44eb)), closes [#333](https://github.com/cgoing-bot/better-chatbot/issues/333)
...
* update sign-out behavior to redirect to sign-in page instead of reloading the window for improved user experience ([3001591](https://github.com/cgoing-bot/better-chatbot/commit/30015915e9c53a047451bc1501148918f0a941b7))
...
* use translation for user settings menu item ([#339](https://github.com/cgoing-bot/better-chatbot/issues/339)) ([eadc71a](https://github.com/cgoing-bot/better-chatbot/commit/eadc71ae6d62ae297aeff44979591bd03a86b19d))
